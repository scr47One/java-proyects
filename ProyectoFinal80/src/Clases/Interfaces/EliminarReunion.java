...
public class EliminarReunion extends javax.swing.JDialog
{

    Nodo InstitucionEncontrada = null;
    boolean carrera=false, reunion=false;

    public EliminarReunion(java.awt.Frame parent, boolean modal) throws IOException
    {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        Reunion = new javax.swing.JLabel();
        ...
        cancelar.setBounds(200, 330, 90, 23);
        ...
        aceptar.setBounds(333, 330, 90, 23);
        ...
        jComboBoxInstitucion.setBounds(250, 140, 230, 30);
        ...
        titulo.setText("Eliminar Reunión");
        pnlInstitucion.add(titulo);
        titulo.setBounds(240, 60, 220, 30);
        ...
        Institucion.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 18)); // NOI18N
        Institucion.setText("Institución");
        pnlInstitucion.add(Institucion);
        Institucion.setBounds(140, 140, 110, 30);
        ...
        jComboBoxCarrera.setBounds(250, 180, 230, 30);

        Carrera2.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 18)); // NOI18N
        Carrera2.setText("Carrera");
        pnlInstitucion.add(Carrera2);
        Carrera2.setBounds(170, 180, 110, 30);

        jComboBoxReunion.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                jComboBoxReunionItemStateChanged(evt);
            }
        });
        jComboBoxReunion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBoxReunionActionPerformed(evt);
            }
        });
        pnlInstitucion.add(jComboBoxReunion);
        jComboBoxReunion.setBounds(250, 220, 230, 30);

        Reunion.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 18)); // NOI18N
        Reunion.setText("Reunión");
        pnlInstitucion.add(Reunion);
        Reunion.setBounds(160, 220, 110, 30);

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Recursos/g.jpg"))); // NOI18N
        fondo.setMaximumSize(new java.awt.Dimension(600, 400));
        fondo.setMinimumSize(new java.awt.Dimension(600, 400));
    ...
    public void habilitarB()
    {
        ...
        if (!jComboBoxInstitucion.getSelectedItem().toString().equals("Selecciona una institucion...") && carrera==true && reunion==true)
        {
    ...
    {//GEN-HEADEREND:event_aceptarActionPerformed
         int valor = JOptionPane.showConfirmDialog(this, "Toda la información relacionada a la reunión se perdera ¿Desea eliminarla? ", "Advertencia", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
        ...
        if (valor == JOptionPane.YES_OPTION)
        {
            ...
            etq[2] = jComboBoxReunion.getSelectedItem().toString();
            ...
            System.out.println("Dirección del Nodo eliminado: " + Eliminacion[1]);
            System.out.println("Nodo eliminado: " + Eliminacion[1].getEtq());
            JOptionPane.showMessageDialog(null, "Reunión Eliminada");
            this.dispose();
        } else
        {
    ...
    {//GEN-HEADEREND:event_jComboBoxInstitucionItemStateChanged
        ...
        if (evt.getStateChange() == ItemEvent.SELECTED)
        {
            ...
            jComboBoxReunion.removeAllItems();
            carrera=false;
            Carrera aux;
    ...
    {//GEN-HEADEREND:event_jComboBoxCarreraItemStateChanged
        ...
        if (evt.getStateChange() == ItemEvent.SELECTED)
        {
            ...
            reunion=false;
            Reunion aux;
            String Nombreaux = jComboBoxCarrera.getSelectedItem().toString();
            ...
            if (auxbusca2 != null&& auxbusca2.getAbj()!=null)
            {
                ...
                jComboBoxReunion.setModel(modelo);
                reunion=true;
            }
    ...
    private void jComboBoxReunionItemStateChanged(java.awt.event.ItemEvent evt)//GEN-FIRST:event_jComboBoxReunionItemStateChanged
    {//GEN-HEADEREND:event_jComboBoxReunionItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_jComboBoxReunionItemStateChanged

    private void jComboBoxReunionActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_jComboBoxReunionActionPerformed
    {//GEN-HEADEREND:event_jComboBoxReunionActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jComboBoxReunionActionPerformed
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                EliminarReunion dialog = null;
                try
                {
                    dialog = new EliminarReunion(new javax.swing.JFrame(), true);
                } catch (IOException ex)
                {
                    Logger.getLogger(EliminarReunion.class.getName()).log(Level.SEVERE, null, ex);
                }
